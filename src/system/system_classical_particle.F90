...
module system_classical_particle_oct_m
  ...
  contains
    ...
    procedure :: set_pointers_to_interaction => classical_particle_set_pointers_to_interaction
...
contains
  ...
  subroutine classical_particle_initial_conditions(this, from_scratch)
    ...
    if (.not. from_scratch) then
      message(1) = "Classical particle mechanics is currently only allowed from scratch"
  ...
  ! ---------------------------------------------------------
  subroutine classical_particle_update_quantity(this, iq, clock)
    class(classical_particle_t),   intent(inout) :: this
 ...
 logical function classical_particle_update_exposed_quantity(this, iq, clock) result(updated)
  ...
  ! ---------------------------------------------------------
  subroutine classical_particle_set_pointers_to_interaction(this, inter)
    class(classical_particle_t), target,  intent(inout) :: this
    class(interaction_abst_t),        intent(inout) :: inter

    PUSH_SUB(classical_particle_set_pointers_to_interaction)
    ...
    POP_SUB(classical_particle_set_pointers_to_interaction)
  end subroutine classical_particle_set_pointers_to_interaction
